 ...
 *         Time: 1:19 PM
 */
public class StsHbnContainer<T> implements Container, Container.Indexed, Container.Sortable,
    ...
    private ApplicationLogger logger = new ApplicationLogger(StsHbnContainer.class);
    ...
    private List<StsContainerFilter> filters;
    ...
    public class EntityItem<T> implements Item {
        ...
        public class EntityProperty implements Property, Property.ValueChangeNotifier {
             ...
             * <p/>
             * StsHbnContainer does not implement this functionality and will throw an UnsupportedOperationException of
    ...
    /**
     * Constructor creates a new instance of StsHbnContainer.
     */
    public StsHbnContainer(Class<T> entityType, SessionFactory sessionFactory) {
        logger.executionTrace();
        ...
        if (cachedEntity != null) {
            for (Object propertyId : cachedEntity.getItemPropertyIds()) {
                ...
                if (cachedProperty instanceof EntityItem.EntityProperty) {
                    @SuppressWarnings("rawtypes")
                    StsHbnContainer.EntityItem.EntityProperty entityProperty = (StsHbnContainer.EntityItem.EntityProperty) cachedProperty;
     ...
     * the new Property are given as parameters. StsHbnContainer automatically adds all fields that are mapped by Hibernate
    ...
    /**
     * This is an StsHbnContainer specific utility method that is used to retrieve the list of embedded property key
     * identifiers.
     */
    ...
    /**
     * Not supported in StsHbnContainer. Indexing/order is controlled by underlying database.
     */
    @Override
     ...
     * <p/>
     * StsHbnContainer does not actually sort anything here, just clearing cache will do the thing lazily.
     */
    @Override
    ...
    /**
     * StsHbnContainer only supports old style addContainerFilter(Object, String, boolean booblean) API and
     * {@link com.vaadin.data.util.filter.SimpleStringFilter}. Support for this newer API maybe in upcoming versions.
     * <p/>
    ...
    public void addContainerFilter(Filter filter) throws UnsupportedFilterException {
        ...
        if (!(filter instanceof SimpleStringFilter)) {
            final String message = "StsHbnContainer only supports old style addContainerFilter(Object, String, boolean booblean) API";
    ...
    public Collection<Filter> getContainerFilters() {
        final HashSet<Filter> set = new HashSet<Filter>(filters.size());
        set.addAll(filters);
        return set;
    }
    ...
    /**
     * This is an internal StsHbnContainer utility method. Determines if a property is contained within an embedded key.
     */
    ...
    /**
     * This is an internal StsHbnContainer utility method. This method triggers events associated with the
    ...
    /**
     * This is an internal StsHbnContainer utility method. Gets a base listing using current ordering criteria.
     */
    ...
    /**
     * This is an internal StsHbnContainer utility method. Return the ordering criteria in the order in which they should
    ...
    /**
     * This is an internal StsHbnContainer utility method. Returns the ordering to use for the container contents. The
    ...
    /**
     * This is an internal StsHbnContainer utility method. Creates the base criteria for entity class and add possible
    ...
    protected Criteria getBaseCriteria() {
        ...
        if (filters != null) {
            for (StsContainerFilter filter : filters) {
                String idName = null;

                if (propertyInEmbeddedKey(filter.getPropertyId()))
                    idName = classMetadata.getIdentifierPropertyName();

                final Criteria subcriteria = filter.customizeCriteria(criteria);
                final Criterion criterion = filter.getCriterion(idName);
                if (criterion != null) {
    ...
    /**
     * This is an internal StsHbnContainer utility method. Natural order is the order in which the database is sorted if
    ...
    /**
     * This is an internal StsHbnContainer utility method to detect identifier of given entity object.
     */
    ...
    /**
     * This is an internal StsHbnContainer utility method. RowBuffer stores a list of entity items to avoid excessive
    ...
    /**
     * This is an internal StsHbnContainer utility method. RowBuffer stores some pojos to avoid excessive number of DB
    ...
    /**
     * This is an internal StsHbnContainer utility method that gets the property name of the identifier.
     */
    ...
    /**
     * This is an internal StsHbnContainer utility method to query new set of entity items to cache from given index.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * This is an internal StsHbnContainer utility method that gets the index of the given identifier.
     */
    ...
    /**
     * This is an internal StsHbnContainer utility method. Adds container filter for hibernate mapped property. For
     * property not mapped by Hibernate.
     */
    public void addContainerFilter(Object propertyId, final String filterString, final boolean ignoreCase, final boolean onlyMatchPrefix) {
        logger.executionTrace();

        addContainerFilter(new StsContainerFilter(propertyId) {
            @Override
            public Criterion getFieldCriterion(String fullPropertyName) {
                final MatchMode matchMode = onlyMatchPrefix ? MatchMode.START : MatchMode.ANYWHERE;
                return ignoreCase ? Restrictions.ilike(fullPropertyName, filterString, matchMode) : Restrictions.like(fullPropertyName, filterString, matchMode);
            }
        });
    }

    /**
     * This is an internal StsHbnContainer utility method that adds a container filter.
     */
    public void addContainerFilter(StsContainerFilter containerFilter) {
        logger.executionTrace();

        if (addedProperties.containsKey(containerFilter.getPropertyId())) {
            final String message = "StsHbnContainer does not support filtering properties not mapped by Hibernate";
            throw new UnsupportedOperationException(message);
        }

        if (filters == null)
            filters = new ArrayList<StsContainerFilter>();
    ...
    /**
     * This is an internal StsHbnContainer utility method that removes container filters for the given property identifier.
     */
    public void removeContainerFilters(Object propertyId) {
        logger.executionTrace();

        if (filters != null) {
            for (Iterator<StsContainerFilter> iterator = filters.iterator(); iterator.hasNext(); ) {
                StsContainerFilter containerFilter = iterator.next();
    ...
    /**
     * This is an internal StsHbnContainer utility method that removes the given container filter.
     */
    @Override
    ...
    /**
     * This is an internal StsHbnContainer utility method that infers the name of the parent field belonging to the current
    ...
    /**
     * This is an internal StsHbnContainer utility method to clear all cache fields.
     */
